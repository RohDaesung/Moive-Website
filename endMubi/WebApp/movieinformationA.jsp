...
<body>
  <header id="header">
    ...
    <section id="movie">
                ...
                <div class="movie">
					...
					<c:forEach var="vo" items="${alist}">
								...
								<div class="input-group">
								  <input type="text" class="form-control" value="${vo.contents }" aria-label="Disabled input example" disabled readonly>
								<a href="commentSearchOne.do?rno=${vo.rno }" class="btn btn-outline-secondary">수정</a>
								<a href="commentDelete.do?rno=${vo.rno}" class="btn btn-outline-secondary">삭제</a>
								</c:if>
								 <c:if test="${login != 1 || delete == 1 || sessionScope.id != vo.id}">
								 <div class="input-group">
								  <input type="text" class="form-control" value="${vo.contents }" aria-label="Disabled input example" disabled readonly>
								 </c:if>
								</div>
		...
		<textarea class="col-auto form-control" type="text" id="reviewContents" name="contents"
