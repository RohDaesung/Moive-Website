                ...
                <div class="movie">
					...
					<div class="movie_chart">
						<div class="chart_cont1">
							<div>
								<div class="poster">
									<figure>
										<img src="assets/img/아바타포스터01.jpg"
											srcset="assets/img/아바타포스터01@.jpg 2x" alt="아바타">
									</figure>
								</div>
							...
							<h1>아바타 : 물의 길</h1>
							<hr>
							아바타: 물의 길은 판도라 행성에서 '제이크 설리'와 '네이티리'가 이룬 가족이 겪게 되는 무자비한 위협과 살아남기
							위해 떠나야 하는 긴 여정과 전투, 그리고 견뎌내야 할 상처에 대한 이야기를 그렸다. 작중 배경은 전작의
							2154년에서 15년이 지난 2169년이며, 족장이 된 제이크 설리와 네이티리는 가정을 꾸리고 네 자녀를 갖는다.
							개중에는 그레이스 박사의 아바타가 낳은 입양아인 키리도 있다. 나이가 어려 냉동 수면을 할 수 없었던 인간 아이
							스파이더도 남아 완전히 부족에 동화된 모습이고, 제이크와 함께 남은 과학자 일행도 잘 정착한 모습이다. 그러나 인류가
							한 척도 아니고 10척에 이르는 대규모 우주선단을 이끌고 다시 판도라로 돌아오고, 이번에는 언옵타늄 채굴 따위가
							아니라 죽어가는 지구를 버리고 판도라로의 완전 이주를 목적으로 하여 개발과 침공을 준비한다. <br>
							<br>
							<br>
							<br>
							<br>
					...
					<hr>
						...
						<div class="input-group">
							...
							<!-- <a href="commentUpdate.do" class="btn btn-dark">수정</a> -->
